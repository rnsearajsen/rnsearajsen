...
<body class="bg" onload="salepricecreate()">
<c:if test="${user != null}">
...
<% session.setAttribute("sesssalepriceevent", "create");  %>
...
<!-- Create Saleprice -->	
		<form action="salepriceinsert">
		<div class="scrolltable">
		<table id="salepricetable">
              <jsp:include page="Saleprice_Form.jsp"></jsp:include>
				<tr>
<!-- Used AJAX to insert entry in DB via 'salepricescript.js' On Button Click function -->
					<td colspan="2" align="center">
			<button type="button" id="btnsalepriceinsert" class="btn btn-primary">Create</button>
			&nbsp; &nbsp; <button type="reset" id="btnsalepriceclear" class="btn btn-primary">Clear</button></td>
				</tr>   				
			</table>
			</div>	
		</form> 
