...
<% session.setAttribute("sessgroupevent", "change");  %>
...
<c:if test="${group != null}">
		<form action="grpupdate">
		<br><div id="message"></div><br>
			<table id="grptable">
               <jsp:include page="Group_Form.jsp"></jsp:include>
				<tr>
					<td colspan="2" align="center"><input type="button" id="btngrpupdate"
						class="btn btn-primary" value="Update" />
						&nbsp;&nbsp;<a role="button" href="grpchange" class="btn btn-primary">Next</a></td>
				</tr>
			</table>
		</form>
</c:if>
<!-- Filter Group Values-->
<c:if test="${group == null}">
		<form action="grpfilter" method="post">		
			<table>
<!-- Group Name -->
				<tr>
					<td>Group Name:</td>
