...
<% session.setAttribute("sessvendorevent", "create");  %>
...
<!-- Create Vendor -->	
		<form action="vendorinsert">
		<div class="scrolltable">
		<table id="vendortable">
              <jsp:include page="Vendor_Form.jsp"></jsp:include>
				<tr>
<!-- Used AJAX to insert entry in DB via 'vendorscript.js' On Button Click function -->
					<td colspan="2" align="center">
			<button type="button" id="btnvendorinsert" class="btn btn-primary">Create</button>
			&nbsp; &nbsp; <button type="reset" id="btnvendorclear" class="btn btn-primary">Clear</button></td>
				</tr>   	
				<tr><td><br></td></tr>			
			</table>
			</div>	
