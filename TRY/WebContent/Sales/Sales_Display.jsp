...
<body class="bg" onload="salesdisp()">
<c:if test="${user != null}">
	...
	<!-- Row 3 (Content) -->
	<!-- Set Attribute for Display in "Sales.jsp" -->
<% session.removeAttribute("sesssalesevent"); %>
<% session.setAttribute("sesssalesevent", "display");  %>
...
<!-- Hide "ID Column" <th id="tableview" style="padding:10px">Sales_ID</th> -->
