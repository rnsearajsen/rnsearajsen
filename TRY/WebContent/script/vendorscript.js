...
$(document).on("click", "#btnvendorinsert", function(){
	that = this;
//get Date/Time
	getdatetime(that);
//Formal Parameter
 	var params = {vendor_id: $("#vendor_id").val(),
		      name: $("#name").val(),
...
//postajax
fnpostajax(that,params,"vendortable");
	});

//******************************************************************************
//Update Vendor
$(document).on("click", "#btnvendorupdate", function(){
	that = this;
//get Date/Time
		getdatetime(that);
//Formal Parameter
...
//*********************************************************
//Clear 
$(document).on("click", "#btnvendorclear", function() {
	// Clear Mandatory Border Color
	fntableclear("vendortable");
});
//*********************************************************
//Get Date & TIme
