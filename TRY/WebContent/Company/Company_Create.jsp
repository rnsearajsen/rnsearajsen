...
<% session.setAttribute("sesscompanyevent", "create");  %>
...
<!-- Create Company -->	
		...
		<form action="compinsert">
		<div id="message"></div><br>
		<table id="comptable">
              <jsp:include page="Company_Form.jsp"></jsp:include>
				<tr>
<!-- Used AJAX to insert entry in DB via 'companyscript.js' On Button Click function -->
					<td colspan="2" align="center">
			<button type="button" id="btncompinsert" class="btn btn-primary">Create</button>
			&nbsp; &nbsp; <button type="reset" id="btncompclear" class="btn btn-primary">Clear</button></td>
				</tr>   
			</table>	
		</form> 
	</div>
