...
public class Crdowner {
  ...
  public Crdowner(Date txndate, String labour_shift, String name) {
	  this.txndate = txndate; 
	  this.labour_shift = labour_shift;
	  this.name = name;
  }

  public Crdowner( Date txndate, String labour_shift, String name, Float crdamount, Float dbamount, String  mop, Float ch_crdamount, Float ch_dbamount, Float amtinhand, String comments, String changedby, Date changeddate, Time changedtime) {	  
  ...
  public Crdowner(Float crdamount, Float dbamount, String mop, Float ch_crdamount, Float ch_dbamount, Float amtinhand, String comments, String changedby, Date changeddate, Time changedtime) {
  ...
  public Crdowner(String name, Float crdamount, String mop, String comments) {
	  this.name = name;
	  this.crdamount = crdamount;
	  this.mop = mop;
	  this.comments = comments;
}
  public Crdowner(String name, Float totcredit, Float crdamount, Float dbamount, String mop, Float ch_crdamount, Float ch_dbamount, Float amtinhand, String comments) {
	  this.name = name;
  ...
  public Crdowner(String name, Float totcredit, Float crdamount, Float dbamount, String mop, Float amtinhand, String comments) {
	  this.name = name;
	  this.totcredit = totcredit;
	  this.crdamount = crdamount;
	  this.dbamount = dbamount;
